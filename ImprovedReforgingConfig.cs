...
{
	public class ImprovedReforgingConfig : ModConfig
	{
        ...
        public bool GoblinTinkererRework; // To see the implementation of this option, see ExampleWings.cs

        //[ReloadRequired]
        [DefaultValue(true)]
        public bool PrefixRework;

        [DefaultValue(100)]
        public int ReforgePricePercentage;
    }
}
